...
program
  ...
  .option(
    "-t, --template <template>",
    "create project use custom template: project|middleware|plugin",
  )
...
program
  ...
  .option(
    "-t, --type <type>",
    "create controller's type, http|grpc|websocket, default is http controller.",
  )
...
program
  ...
  .option(
    "-o, --orm <orm>",
    "used orm module (thinkorm, typeorm), default is typeorm",
  )
...
program
  ...
  .option(
    "-t, --type <type>",
    "controller type: http|grpc|graphql|websocket, default is http",
  )
