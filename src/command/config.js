...
module.exports = {
  ...
  TEMPLATE_PATH: path.join(rootDir, "templates/project"),
  ...
  CLI_TEMPLATE_URL_GITEE:
    "https://gitee.com/richenlin/koatty_template_cli.git#main",
  CLI_TEMPLATE_PATH: path.join(rootDir, "templates/module"),

  COM_TEMPLATE_NAME: "koatty_template_component",
  COM_TEMPLATE_URL:
    "https://github.com/Koatty/koatty_template_component.git#main",
  COM_TEMPLATE_URL_GITEE:
    "https://gitee.com/richenlin/koatty_template_component.git#main",
  COM_TEMPLATE_PATH: path.join(rootDir, "templates/component"),
...
https://github.com/koatty
  ...
  TYPEORM_PLUGIN_CONFIG: {
    TypeormPlugin: {
      ...
      logging: true,
      entities: [
        `${process.env.APP_PATH || "${process.env.APP_PATH}"}/model/*`,
      ],
    },
  },
};
